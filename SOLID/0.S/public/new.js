...
let musicPlayer = new MusicPlayer_1.MusicPlayer(0, 50);
let engine = new Engine_1.Engine();
let fuelTank = new FuelTank_1.FuelTank(defaultFuel, defaultFuelMileage, defaultFuelMaxCapacity);
let car = new Car_1.Car(musicPlayer, engine, fuelTank);
